...
class _RegistrovaniPutnikDialogState extends State<RegistrovaniPutnikDialog> {
  ...
  Future<void> _createNewPutnik() async {
    ...
    // ✅ Putnik se kreira BEZ dodeljenog vozača - dodeljivanje se radi preko DodeliPutnike screen-a

    final noviPutnik = RegistrovaniPutnik(
      id: '', // Will be generated by database
      putnikIme: _imeController.text.trim(),
      tip: _tip,
      brojMesta: int.tryParse(_brojMestaController.text) ?? 1,
      ...
      vozacId: null, // ✅ Putnik se kreira BEZ vozača - dodeljivanje preko DodeliPutnike
      // Polja za račun
